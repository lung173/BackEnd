"""
Django settings for pusat project.
"""
...
WSGI_APPLICATION = 'pusat.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': config('DB_PASSWORD', default='mepetdeadline'),
        'HOST': config('DB_HOST', default='db.jdIcvzxeodnvvvnqgcpvn.supabase.co'),
